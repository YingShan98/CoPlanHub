  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      ...
      <p class="text-center text-sm mt-4 text-sky-500">
        <.link href={~p"/users/register"} class="text-sky-500 hover:underline hover:text-sky-400">Register</.link>
        | <.link href={~p"/users/log_in"} class="text-sky-500 hover:underline hover:text-sky-400">Log in</.link>
      </p>
    </div>
    """
  end
